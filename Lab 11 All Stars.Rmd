...
```
There are `r arielrachelversions` different versions of each name for each year, and the chances a girl would have a version of the name Ariel or Rachel in each year is `r arielrachelprop`.
